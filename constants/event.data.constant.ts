const DATA = [
  {
    ...
    smallPoster: 'https://example.com/poster.jpg',
    ...
    shortDescription:
      'Exciting A-League match between Melbourne Victory and Sydney FC.',
  ...
  },
  {
    ...
    KisaAciklama:
      'Teknolojinin sanatla buluştuğu dijital eserlerin sergilendiği event.',
    BiletSatisLinki: null,
    UcretsizMi: true,
    Resim:
      'https://static.wixstatic.com/media/9c95f9_1bd2debc26f04768a02d64e13d1d39d4~mv2.jpg/v1/fill/w_640,h_426,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/9c95f9_1bd2debc26f04768a02d64e13d1d39d4~mv2.jpg',
  ...
  },
  {
    ...
    KisaAciklama:
      'Ünlü fotoğrafçıların anı yakalama sanatının sergilendiği event.',
    BiletSatisLinki: null,
    UcretsizMi: true,
    Resim:
      'https://cdn1.ntv.com.tr/gorsel/bP74-d_4nkGDzjUXdrd_Bg.jpg?width=1000&mode=crop&scale=both',
