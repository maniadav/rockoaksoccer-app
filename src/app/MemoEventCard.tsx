...
const MemoShimmerList = memo(({ gridLayout, count = 5 }: any) => {
  ...
  return (
    <FlatList
      ...
      renderItem={() => <FlexiEventCardShimmer />}
    />
  );
});

const MemoEventList = memo(({ data, gridLayout, navigation }: any) => (
  <FlatList
    key={gridLayout ? "grid-2-col" : "grid-1-col"}
    data={data}
    extraData={gridLayout}
...
export { MemoEventList, MemoShimmerList };
