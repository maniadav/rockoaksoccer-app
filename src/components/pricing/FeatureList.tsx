...
const FeatureList: React.FC<FeatureListProps> = ({
  ...
  const getFeatureIcon = (type: string, isIncluded: boolean) => {
    // Special color for Holiday Clinic feature
    const iconColor =
      type === "Holiday Clinic" && isIncluded ? "#ff5e62" : "#993b1f";
      ...
      case "Training":
        return (
          <MaterialCommunityIcons
            name="whistle"
            size={22}
            color={isIncluded ? iconColor : "#ccc"}
          />
        );
      case "Matches":
        return (
