  ...
  return (
    <View style={styles.quickLinksContainer}>
      <TouchableOpacity style={styles.quickLink} onPress={() => onPressed()}>
        <View style={[styles.quickLinkIcon, { backgroundColor: "#d32f2f" }]}>
      ...
      <TouchableOpacity style={styles.quickLink}>
        <View style={[styles.quickLinkIcon, { backgroundColor: "#388e3c" }]}>
      ...
      <TouchableOpacity style={styles.quickLink}>
        <View style={[styles.quickLinkIcon, { backgroundColor: "#1976d2" }]}>
      ...
      <TouchableOpacity style={styles.quickLink} onPress={() => makeCall()}>
        <View style={[styles.quickLinkIcon, { backgroundColor: "#f57c00" }]}>
